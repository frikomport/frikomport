...
public class Constants {
    ...
    /**
     * Application scope attribute that allows true or false override of grouping used when data binding variables of class Int, Long or Double.
     */
    public static final String OVERRIDE_GROUPING_KEY = "overrideFieldBindingLocaleGroupingUsed";

    /**
     * Application scope attribute that allows override of the number of decimal digits used when data binding variables of class Int or Long.
     */
    public static final String OVERRIDE_INTEGER_KEY = "overrideFieldBindingLocaleIntegerDigits";

    /**
     * Application scope attribute that allows override of the number of decimal digits used when data binding variables of class Double.
     */
