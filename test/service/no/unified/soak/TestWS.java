...
public class TestWS {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            adminRoles = "Administrator,FKPAdministrator";
            eventResponsible = "Kursansvarlig,FKPMoteansvarlig";
            eventAdminRoles = "Opplaringsansvarlig,FKPMoteadministrator";
            String ansattRoles = "Ansatt";
            String readeRoles = "FKPLesebruker";

            extUser.setRolenames(SVVUserDAOWS.getInnerTagValuesInTag(ret, "urn1:svvrole", "Key", new String[] { adminRoles, eventAdminRoles,
