...
public class SVVUserDAOWSTest extends TestCase {
	...
	public void testParseUserXML () {
		...
		assertEquals("Fornavn inneholder feil.", "Anders[øæå]", extUser.getFirst_name());
		assertEquals("Etternavn inneholder feil.", "Aalberg[øæå]", extUser.getLast_name());
		assertEquals("Navn (hele navnet i ett felt) inneholder feil.", "Anders Aalberg[øæå]", extUser.getName());
