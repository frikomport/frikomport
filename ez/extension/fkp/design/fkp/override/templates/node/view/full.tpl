...
{*
	 [{$content_version.contentobject_attributes|attribute( show, 0 )} | {$content_version.contentobject_attributes}]
*}
...
{*
	 [{$ContentObjectAttribute:item|attribute( show, 0 )} | {$ContentObjectAttribute:item}]
*}
