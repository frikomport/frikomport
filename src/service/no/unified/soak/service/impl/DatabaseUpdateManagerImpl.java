...
public class DatabaseUpdateManagerImpl extends BaseManager implements DatabaseUpdateManager {
	...
	private void changeRolesBySQL() {
		...
		try {
			...
			log
					.error(
							"Feil ved dataendring i \"Role\". Dersom det finnes en rad i Role med name='instructor' m� dette name endres til 'eventresponsible'.",
							e);
		}
	}
	...
	private void insertDefaultValues() {
		...
		if (ApplicationResourcesUtil.isSVV()) {
			...
			if (regioner.isEmpty()) {
				...
				south = new Organization("Region S�r", 4, regionTypeDBValue, true, null);
				east = new Organization("Region �st", 5, regionTypeDBValue, true, null);
			...
			// omr�der
			organizationsToInsert.add(new Organization("Omr�de Helgeland", 0, areaTypeDBValue, true, north));
			organizationsToInsert.add(new Organization("Omr�de Salten", 0, areaTypeDBValue, true, north));
			organizationsToInsert.add(new Organization("Omr�de Midtre H�logaland", 0, areaTypeDBValue, true, north));
			organizationsToInsert.add(new Organization("Omr�de Midtre Troms", 0, areaTypeDBValue, true, north));
			organizationsToInsert.add(new Organization("Omr�de Nord-Troms og Vest-Finnmark", 0, areaTypeDBValue, true, north));
			organizationsToInsert.add(new Organization("Omr�de �st-Finnmark", 0, areaTypeDBValue, true, north));

			organizationsToInsert.add(new Organization("Omr�de M�re og Romsdal", 0, areaTypeDBValue, true, mid));
			organizationsToInsert.add(new Organization("Omr�de S�r-Tr�ndelag", 0, areaTypeDBValue, true, mid));
			organizationsToInsert.add(new Organization("Omr�de Nord-Tr�ndelag", 0, areaTypeDBValue, true, mid));

			organizationsToInsert.add(new Organization("Omr�de S�r-Rogaland", 0, areaTypeDBValue, true, west));
			organizationsToInsert.add(new Organization("Omr�de Haugaland og Sunnhordaland", 0, areaTypeDBValue, true, west));
			organizationsToInsert.add(new Organization("Omr�de Bergen og Nordhordaland", 0, areaTypeDBValue, true, west));
			organizationsToInsert.add(new Organization("Omr�de Indre Hordaland og Sogn og Fjordane", 0, areaTypeDBValue, true, west));

			organizationsToInsert.add(new Organization("Omr�de Agder", 0, areaTypeDBValue, true, south));
			organizationsToInsert.add(new Organization("Omr�de Nedre-Telemark og Vestfold", 0, areaTypeDBValue, true, south));
			organizationsToInsert.add(new Organization("Omr�de �vre-Telemark og Buskerud", 0, areaTypeDBValue, true, south));

			organizationsToInsert.add(new Organization("Omr�de Follo og �stfold", 0, areaTypeDBValue, true, east));
			organizationsToInsert.add(new Organization("Omr�de Asker, B�rum og Oslo", 0, areaTypeDBValue, true, east));
			organizationsToInsert.add(new Organization("Omr�de Gl�mdal og Romerike", 0, areaTypeDBValue, true, east));
			organizationsToInsert.add(new Organization("Omr�de Hedemarken-�sterdalen", 0, areaTypeDBValue, true, east));
			organizationsToInsert.add(new Organization("Omr�de Oppland", 0, areaTypeDBValue, true, east));

			// fylker
			organizationsToInsert.add(new Organization("�stfold", 1, countyTypeDBValue, true, east));
			...
			organizationsToInsert.add(new Organization("M�re og Romsdal", 15, countyTypeDBValue, true, mid));
			organizationsToInsert.add(new Organization("S�r-Tr�ndelag", 16, countyTypeDBValue, true, mid));
			organizationsToInsert.add(new Organization("Nord-Tr�ndelag", 17, countyTypeDBValue, true, mid));
			...
			while (it.hasNext()) {
				...
				if (registration.getUsername() == null || registration.getUsername().trim().length() == 0) {
					if (EmailValidator.getInstance().isValid(registration.getEmail())) {
						...
						log.warn("F�lgende p�melding har ugyldig epostadresse: " + registration.toString());
					}
				}
			...
			while (it.hasNext()) {
				...
				if (serviceArea.getOrganizationid() == -1) {
					for (int i = 0; i < organizations.size(); i++) {
						...
						if (i == 0) { // oppdater f�rste og lag kopier
							// etterpå.
