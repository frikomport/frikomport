...
public class UserCookie extends BaseObject {
    ...
    * @hibernate.property column="date_created" not-null="true"
    ...
    public boolean equals(Object o) {
        ...
        if ((cookieId != null) ? (!cookieId.equals(userCookie.cookieId))
                                   : (userCookie.cookieId != null)) {
            return false;
        }

        if ((dateCreated != null) ? (!dateCreated.equals(userCookie.dateCreated))
                                      : (userCookie.dateCreated != null)) {
            return false;
        }

        if ((username != null) ? (!username.equals(userCookie.username))
    ...
    public int hashCode() {
        ...
        result = (29 * result) +
            ((dateCreated != null) ? dateCreated.hashCode() : 0);
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("id",
            this.id).append("username", this.username)
                                                                        .append("cookieId",
            this.cookieId).append("dateCreated", this.dateCreated).toString();
    }
}
