...
public class Constants {
    ...
    /**
     * The session scope attribute under which the User object for the alternative user is stored.
     */
    ...
    /**
     * The session scope attribute under which the course object for the original (before change) course is stored.
     */
    ...
    /**
     * Application scope attribute that allows true or false override of grouping used when data binding variables of
     * class Int, Long or Double.
     */
    public static final String OVERRIDE_GROUPING_KEY = "overrideFieldBindingLocaleGroupingUsed";

    /**
     * Application scope attribute that allows override of the number of decimal digits used when data binding variables
     * of class Int or Long.
     */
    ...
    /**
     * Session scope key for messages list used in messages.jsp. If this constant is changed, also change messages.jsp
     * or whatever jsp is reading from this key.
     */
    ...
    public static final long TASK_RUN_INTERVAL_EVERY_HOUR = 3600000; // 60 minutter
    public static final long TASK_RUN_INTERVAL_EVERY_DAY = 86400000; // 24 timer
