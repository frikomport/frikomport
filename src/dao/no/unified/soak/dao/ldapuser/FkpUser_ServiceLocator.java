...
public class FkpUser_ServiceLocator extends org.apache.axis.client.Service implements no.unified.soak.dao.ldapuser.FkpUser_Service {
    ...
    public no.unified.soak.dao.ldapuser.FkpUserPortType getFkpUserPort() throws javax.xml.rpc.ServiceException {
    ...
    public no.unified.soak.dao.ldapuser.FkpUserPortType getFkpUserPort(java.net.URL portAddress)
            throws javax.xml.rpc.ServiceException {
        try {
            no.unified.soak.dao.ldapuser.FkpUserBindingStub _stub = new no.unified.soak.dao.ldapuser.FkpUserBindingStub(
                    portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (no.unified.soak.dao.ldapuser.FkpUserPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                no.unified.soak.dao.ldapuser.FkpUserBindingStub _stub = new no.unified.soak.dao.ldapuser.FkpUserBindingStub(
                        new java.net.URL(FkpUserPort_address), this);
                _stub.setPortName(getFkpUserPortWSDDServiceName());
                return _stub;
            }
    ...
    public void setEndpointAddress(java.lang.String portName, java.lang.String address) throws javax.xml.rpc.ServiceException {
        if ("LDAPUserPort".equals(portName)) {
