...
<div class="message" style="font-size: 12px"><fmt:message key="courseNotification.askmailnotification"/></div>
...
<table class="detail">
    <tr>
		...
		<c:if test="${isAdmin || isEducationResponsible || (isCourseResponsible)}">
            ...
            <input type="submit" class="button" name="confirm" onclick="bCancel=true"
