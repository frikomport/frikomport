...
<table class="detail">
    ...
    <tr>
        ...
        <td>
         <a href="<fmt:message key="course.responsible.urlpart"/>/<c:out value="${registration.course.responsible.url_name}"/>" target="_top"><c:out value="${registration.course.responsible.name}"/></a>
        </td>
    </tr>
