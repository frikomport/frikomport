...
public class FkpUserBindingStub extends org.apache.axis.client.Stub implements no.unified.soak.dao.fkpuser.FkpUserPortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnType(new javax.xml.namespace.QName("urn:fkpuser", "FkpUser"));
        oper.setReturnClass(no.unified.soak.dao.fkpuser.FkpUser_Type.class);
        ...
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("urn:fkpuser", "FkpUsers"));
        oper.setReturnClass(no.unified.soak.dao.fkpuser.FkpUser_Type[].class);
        ...
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("urn:fkpuser", "FkpRoles"));
        oper.setReturnClass(no.unified.soak.dao.fkpuser.FkpRole[].class);
